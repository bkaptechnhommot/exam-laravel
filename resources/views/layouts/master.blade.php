...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{url('public')}}/backend/fonts/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{url('public')}}/backend/fonts/ionicons.min.css">
  <!-- Theme style -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('read-cate')}}"><i class="fa fa-circle-o"></i> Danh sách danh mục</a></li>
            <li><a href="{{route('add-cate')}}"><i class="fa fa-circle-o"></i> Thêm mới danh mục</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('read-pro')}}"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
            <li><a href="{{route('add-pro')}}"><i class="fa fa-circle-o"></i> Thêm mới sản phẩm</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('read-user')}}"><i class="fa fa-circle-o"></i> Danh sách tài khoản</a></li>
            <li><a href="{{route('add-user')}}"><i class="fa fa-circle-o"></i> Thêm mới tài khoản</a></li>
          </ul>
        </li>
...
<!-- jQuery 2.2.3 -->
<script src="{{url('public')}}/backend/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="{{url('public')}}/backend/bootstrap/js/bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="{{url('public')}}/backend/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="{{url('public')}}/backend/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
